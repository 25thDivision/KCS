...
python3 run_suite.py --experiment ibm ibm-baseline -c surface_code -d 3 -m CNN GCNII APPNP GraphTransformer GCN GAT GNN GraphMamba &
...
python3 run_suite.py --experiment ibm ibm-baseline -c surface_code -d 5 7 -m CNN GCNII APPNP GraphTransformer GCN GAT GNN GraphMamba
